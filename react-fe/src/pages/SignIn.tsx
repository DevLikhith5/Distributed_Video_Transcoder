...
import UploadIllustration from "@/assets/undraw_image-upload_7b3b.svg";
      ...
      <div className="hidden lg:flex flex-1 bg-gradient-to-br from-primary/20 via-primary/10 to-background items-center justify-center p-12">
        <div className="max-w-lg space-y-6 text-center">
          ...
          <p className="text-muted-foreground text-lg leading-relaxed">
            ...
            <span className="text-primary font-semibold">StreamForge</span> to
            power their video workflows on the cloud.
          </p>
        </div>
      </div>
    </div>
